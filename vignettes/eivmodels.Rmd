...
Let's fit the EIV integrated Gaussian process model. This is a much richer model and will also take longer to run than than the simpler models. However, an advantage is that it  provides the underlying rate process directly from the model.
